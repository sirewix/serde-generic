...
impl MultiName {
    pub fn to_serde_generic_term_repr(&self) -> TokenStream {
        let serialize = &self.serialize.value;
        let serialize_renamed = self.serialize_renamed;
        let deserialize = &self.deserialize.value;
        let deserialize_renamed = self.deserialize_renamed;
        let deserialize_aliases = self.deserialize_aliases.iter();
        quote::quote! {
            ::serde_generic::serde::MultiName {
                serialize: #serialize,
                serialize_renamed: #serialize_renamed,
                deserialize: #deserialize,
                deserialize_renamed: #deserialize_renamed,
